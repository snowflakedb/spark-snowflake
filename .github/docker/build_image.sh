...
# Build docker image
docker build \
--build-arg SPARK_URL=https://archive.apache.org/dist/spark/spark-2.2.3/spark-2.2.3-bin-hadoop2.7.tgz \
--build-arg SPARK_BINARY_NAME=spark-2.2.3-bin-hadoop2.7.tgz \
