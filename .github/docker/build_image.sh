...
# Build docker image
docker build \
--build-arg SPARK_URL=https://archive.apache.org/dist/spark/spark-3.4.1/spark-3.4.1-bin-hadoop3.tgz \
--build-arg SPARK_BINARY_NAME=spark-3.4.1-bin-hadoop3.tgz \
