...
spark-submit --jars /home/hadoop/spark-snowflake-jar_assembly/target/scala-2.12/spark-snowflake-assembly-2.8.2-spark_3.0.jar --class net.snowflake.spark.snowflake.ClusterTest   --master spark://localhost:7077   /home/hadoop/spark-snowflake-jar_assembly/ClusterTest/target/scala-2.12/ClusterTest-assembly-1.0.jar remote "net.snowflake.spark.snowflake.testsuite.StressReadWriteSuite;" 3
