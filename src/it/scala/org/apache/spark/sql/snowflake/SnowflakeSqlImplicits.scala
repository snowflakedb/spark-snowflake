 ...
 * @since 1.6.0
 */
abstract class SnowflakeSQLImplicits(sfSession: SFTestWrapperSparkSession)
   ...
   * @since 1.6.0
   */
  implicit def localSeqToDatasetHolder[T: Encoder](data: Seq[T]): SFDatasetHolder[T] = {
    SFDatasetHolder(data, sfSession)
  }
