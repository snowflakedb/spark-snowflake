...
import net.snowflake.spark.snowflake_beta.io.{SupportedFormat, SupportedSource}
...
private[snowflake_beta] case class SnowflakeRelation(
...
private[snowflake_beta] object SnowflakeRelation {
