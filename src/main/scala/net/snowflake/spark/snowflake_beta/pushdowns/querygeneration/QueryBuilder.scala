...
import net.snowflake.spark.snowflake_beta.{SnowflakePushdownException, SnowflakeRelation, SnowflakeSQLStatement}
...
private[querygeneration] class QueryBuilder(plan: LogicalPlan) {
  ...
  private[snowflake_beta] lazy val treeRoot: SnowflakeQuery = {
    try {
...
/** QueryBuilder object that serves as an external interface for building queries.
  ...
  */
private[snowflake_beta] object QueryBuilder {
