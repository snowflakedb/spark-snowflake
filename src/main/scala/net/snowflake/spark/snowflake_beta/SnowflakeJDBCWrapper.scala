...
import net.snowflake.spark.snowflake_beta.Utils.JDBC_DRIVER
...
/**
  ...
  */
private[snowflake_beta] class JDBCWrapper {
...
private[snowflake_beta] object DefaultJDBCWrapper extends JDBCWrapper {
...
/**
  * SQL string wrapper
  */
private[snowflake_beta] class SnowflakeSQLStatement(
                                                val numOfVar: Int = 0,
...
private[snowflake_beta] object EmptySnowflakeSQLStatement {
  def apply(): SnowflakeSQLStatement = new SnowflakeSQLStatement()
}

private[snowflake_beta] sealed trait StatementElement {
...
private[snowflake_beta] case class ConstantString(override val value: String) extends StatementElement

private[snowflake_beta] sealed trait VariableElement[T] extends StatementElement {
  override val value = "?"
...
private[snowflake_beta] case class Identifier(override val variable: String) extends VariableElement[String] {
  override val value: String = "identifier(?)"
}

private[snowflake_beta] case class StringVariable(override val variable: String) extends VariableElement[String] {
  override def sql: String = s"""'$variable'"""
}

private[snowflake_beta] case class IntVariable(override val variable: Int) extends VariableElement[Int]

private[snowflake_beta] case class LongVariable(override val variable: Long) extends VariableElement[Long]

private[snowflake_beta] case class ShortVariable(override val variable: Short) extends VariableElement[Short]

private[snowflake_beta] case class FloatVariable(override val variable: Float) extends VariableElement[Float]

private[snowflake_beta] case class DoubleVariable(override val variable: Double) extends VariableElement[Double]

private[snowflake_beta] case class BooleanVariable(override val variable: Boolean) extends VariableElement[Boolean]

private[snowflake_beta] case class ByteVariable(override val variable: Byte) extends VariableElement[Byte]
