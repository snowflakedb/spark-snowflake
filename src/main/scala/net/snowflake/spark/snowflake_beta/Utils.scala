...
import net.snowflake.spark.snowflake_beta.FSType.FSType
...
object Utils {
   ...
   */
  val SNOWFLAKE_SOURCE_NAME = "net.snowflake.spark.snowflake_beta"

  private[snowflake_beta] val JDBC_DRIVER = "net.snowflake.client.jdbc.SnowflakeDriver"
  ...
  private[snowflake_beta] def setLastCopyUnload(select: String): Unit = {
  ...
  private[snowflake_beta] def setLastCopyLoad(select: String): Unit = {
    lastCopyLoad = select
  }
  ...
  private[snowflake_beta] def setLastPutCommand(set: String): Unit = {
    lastPutCommand = set
  }
  ...
  private[snowflake_beta] def setLastGetCommand(get: String): Unit = {
    lastGetCommand = get
  }
  ...
  private [snowflake_beta] def genPrologueSql(params: MergedParameters) : SnowflakeSQLStatement = {
  ...
  private [snowflake_beta] def genEpilogueSql(params: MergedParameters) : SnowflakeSQLStatement = {
  ...
  private [snowflake_beta] def executePreActions(
  ...
  private [snowflake_beta] def executePostActions(
                                              jdbcWrapper: JDBCWrapper,
                                              conn: Connection,
                                              params: MergedParameters,
                                              table: Option[TableName]
