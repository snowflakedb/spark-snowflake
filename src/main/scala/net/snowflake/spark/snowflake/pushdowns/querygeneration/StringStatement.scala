...
import org.apache.spark.sql.catalyst.expressions.{Ascii, Attribute, Concat, Expression, Like, Lower, StringReverse, StringLPad, StringRPad, StringTranslate, StringTrim, StringTrimLeft, StringTrimRight, Substring, Upper}
